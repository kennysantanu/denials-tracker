...
ARG PRIVATE_OPENAI_API_KEY
ARG PRIVATE_OPENAI_API_BASE_URL
ARG PRIVATE_OPENAI_MODEL

# Set environment variables from build arguments
ENV PUBLIC_SUPABASE_URL=${PUBLIC_SUPABASE_URL}
ENV PUBLIC_SUPABASE_ANON_KEY=${PUBLIC_SUPABASE_ANON_KEY}
ENV PRIVATE_SUPABASE_SERVICE_ROLE_KEY=${PRIVATE_SUPABASE_SERVICE_ROLE_KEY}
ENV PRIVATE_OPENAI_API_KEY=${PRIVATE_OPENAI_API_KEY}
ENV PRIVATE_OPENAI_API_BASE_URL=${PRIVATE_OPENAI_API_BASE_URL}
ENV PRIVATE_OPENAI_MODEL=${PRIVATE_OPENAI_MODEL}
