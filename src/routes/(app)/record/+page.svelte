	...
	<label class="label">
		...
		<div class="flex flex-row space-x-8">
			<select class="select">
				...
				<option value="3">Lastname, Firstname</option>
			</select>
			<button type="button" class="variant-filled-secondary btn">Add New Patient</button>
		</div>
	</label>
	<label class="label">
		...
		<div class="flex flex-row">
			<div>
				...
				<span class="text-surface-800"
					>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean convallis lorem sed nulla
					tristique eleifend. Mauris lacinia dapibus magna, ut bibendum ex scelerisque eu. Sed a
					fermentum nulla. Nullam molestie erat non mauris mattis euismod. Mauris nec dolor ac ipsum
					viverra egestas sed ut risus. Nullam rhoncus dictum massa, vel condimentum risus
					scelerisque sed. Aliquam non orci sem. Nunc eget rhoncus est.</span
				>
			</div>
			<div>
